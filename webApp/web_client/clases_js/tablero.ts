...
let canvasPiezas;
// '' is empty.
let piezasArray = new Array(['','','','','','','',''], ['','','','','','','',''], ['','','','','','','',''], ['','','','','','','',''], ['','','','','','','',''], ['','','','','','','',''], ['','','','','','','',''], ['','','','','','','','']);
//							 f, c
let clicksTablero = new Array([-1, -1], [-1, -1]);
let clicksPiezas = new Array([-1, -1], [-1, -1]);
...
class Tablero
{
	public static iniciar()
	{
		...
		let canvasTablero = document.getElementById('lienzoTablero');
		...
		document.getElementById('lienzoTablero').addEventListener('mousedown', function (e) {
			let ClientRect = canvasTablero.getBoundingClientRect();
	...
	public static marcar(f : number, c : number, desde : string = 'tablero')
	{
		if (desde == 'tablero')
		{
	...
	public static parseResponseToArray(response : string)
	{
...
//[[Rb, Nb, Bb, Qb, Kb, Bb, Nb, Rb], [Pb, Pb, Pb, Pb, Pb, Pb, Pb, Pb], [ , , , , , , , ], [ , , , , , , , ], [ , , , , , , , ], [ , , , , , , , ], [Pw, Pw, Pw, Pw, Pw, Pw, Pw, Pw], [Rw, Nw, Bw, Qw, Kw, Bw, Nw, Rw]]
	...
	public static detectarPieza(x : Number, y : Number, desde : string = 'tablero')
	{
		let f : number = 0;
		let c : number = 0;
	...
	public static mover()
	{
		...
		let p : string = (<HTMLInputElement> document.getElementById("txtPieza")).value;
		let co : string = (<HTMLInputElement> document.getElementById("txtColor")).value;
		let f : number = Number((<HTMLInputElement> document.getElementById("txtFila")).value);
		let c : number = Number((<HTMLInputElement> document.getElementById("txtColumna")).value);
	...
	public static dibujarPiezasExtra()
	{
	...
	public static colocarPiezas(p : string, co : string, f : number, c : number)
	{
