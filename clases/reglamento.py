...
class Reglamento:
	...
	def moveQueen(self, __movimiento, __jugador, matrizTablero):
		...
		if self.esCaptura(__movimiento, "moveQueen"):
			...
			retorno = self.movimiento(__jugador, __d, matrizTablero, "moveQueen", __movimiento, 0)
			print("El movimiento retornó: " + str(retorno))
	...
	def moveKing(self, __movimiento, __jugador, matrizTablero):
		...
		if self.esCaptura(__movimiento, "moveKing"):
			...
			retorno = self.movimiento(__jugador, __d, matrizTablero, "moveKing", __movimiento, 0)
			print("El movimiento retornó: " + str(retorno))
			...
			if __movimiento[0] == "R":
				...
				if __movimiento[0] == "N":
					...
					if __movimiento[0] == "B":
						...
						if __movimiento[0] == "K":
							retorno = self.moveKing(__movimiento, __jugador, matrizTablero)
						else:
							if __movimiento[0] == "Q":
	...
	def mover(self, __movimiento, __jugador, matrizTablero, __turno):
		...
		if self.verificarTurno(__jugador) and self.verificarSintaxis(__movimiento, __jugador):
